...
def main(unused_argv):
    #Load the data
    dataset = scipy.io.loadmat('NewDataset/new_dataset_s.mat')
    ...
    mnist_classifier = tf.estimator.Estimator(
      model_fn=cnn_model_fn, model_dir="/tmp/BCNNtrain2_s", params= {"train":batch_train, "test":batch_test,"nbr_class":nbr_class  })
