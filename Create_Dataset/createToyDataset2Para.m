...
for i=1: numberOfImages
    ...
    RGB = insertShape(zeros(sizeOfImages),'FilledRectangle',[centerX-radius centerY-radius radius*2 radius*2],'Color', [1 1 1]);
    ...
    if(whichShape==0)
        ...
        % 20*20
        RGB = insertShape(squeeze(allClass2(i,:,:)),'FilledCircle',[centerX centerY radius],'Color', [1 1 1]);
        
    else
        %Draw a parallelogram
        RGB = insertShape(squeeze(allClass2(i,:,:)),'FilledPolygon',[centerX-radius centerY-radius centerX centerY-radius centerX+radius centerY+radius centerX centerY+radius  ],'Color', [1 1 1]);
    end
...
save('allClass2Para.mat', 'allClass2')
