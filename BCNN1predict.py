# This file is the predicting part of the BCNN. The trained BCNN in BCNN1.py predicts the class of images from a toy dataset.
...
def main(unused_argv):
 ...
 #       sw.show_one_image(i, x_test)
    ...
    mnist_classifier = tf.estimator.Estimator(
      model_fn=cnn_model_fn, model_dir="/tmp/BCNN1train", params= {"train":batch_train, "test":batch_test,
                                                                    "nbr_patch":nbr_patch, 
                                                                    "nbr_class":nbr_class,
