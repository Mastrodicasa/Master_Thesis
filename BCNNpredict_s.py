# This file is the predicting part of the BCNN. The trained BCNN_s in BCNN.py predicts the class of images from a toy dataset.
# The image are divided in patches of 10*10 with a stride of 10.
...
def main(unused_argv):
 ...
 #       sw.show_one_image(i, x_test)
    ...
    mnist_classifier = tf.estimator.Estimator(
      model_fn=cnn_model_fn, model_dir="/tmp/BCNNtrain2_s", params= {"train":batch_train, "test":batch_test,
                                                                    "nbr_patch":nbr_patch, 
                                                                    "nbr_class":nbr_class,
