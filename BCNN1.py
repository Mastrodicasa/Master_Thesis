# This file is the training part of BCNN. It trains on the new dataset created by the PCNN without the non discriminative patches.
# In the end, the BCNN should predict which class (2 discriminative) an image belongs to.
...
#    label=np.concatenate((B2_label,A_label, B1_label, A_label, B2_label), axis=0)
    ...
    x_train, x_test, y_train, y_test = sk.train_test_split(A_patch,A_label,test_size=0.10, random_state = 42)
    ...
    mnist_classifier = tf.estimator.Estimator(
      model_fn=cnn_model_fn, model_dir="/tmp/BCNN1train", params= {"train":batch_train, "test":batch_test,"nbr_class":nbr_class  })
